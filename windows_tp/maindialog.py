...
#
# Created: Sat Aug 23 20:07:35 2014
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        item.setText(_translate("Dialog", "公司"))
        ...
        item.setText(_translate("Dialog", "手机"))
        item = self.tbwResult.horizontalHeaderItem(4)
        item.setText(_translate("Dialog", "传真"))
        item = self.tbwResult.horizontalHeaderItem(5)
        item.setText(_translate("Dialog", "邮编"))
        item = self.tbwResult.horizontalHeaderItem(6)
        item.setText(_translate("Dialog", "公司主页"))
        item = self.tbwResult.horizontalHeaderItem(7)
        item.setText(_translate("Dialog", "公司地址"))
        item = self.tbwResult.horizontalHeaderItem(8)
        item.setText(_translate("Dialog", "备注"))
        self.tabTaskRuning.setStatusTip(_translate("Dialog", "Task is running"))
        self.tabTasks.setTabText(self.tabTasks.indexOf(self.tabTaskRuning), _translate("Dialog", "未完成"))
        self.tabTasks.setTabText(self.tabTasks.indexOf(self.tabTaskCompleted), _translate("Dialog", "已完成"))
